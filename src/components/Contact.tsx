...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-20 relative">
      <div className="absolute inset-0 bg-gradient-to-b from-dark/90 to-dark opacity-90 z-0"></div>
          ...
          <motion.div variants={itemVariants} className="space-y-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:harshargoli09@gmail.com" className="text-gray-300 hover:text-primary transition-colors">
                      harshargoli09@gmail.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="tel:+19403046367" className="text-gray-300 hover:text-primary transition-colors">
                      +1 (940) 304-6367
                    </a>
                  </div>
                </div>
            ...
            <div className="glass-panel p-6 rounded-xl">
              ...
              <div className="flex space-x-4">
                ...
                <a
                  href="mailto:harshargoli09@gmail.com"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-3 rounded-lg bg-primary/20 text-primary hover:bg-primary/30 transition-colors"
                  aria-label="Gmail"
